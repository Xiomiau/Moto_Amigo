...
/**
 * Botón naranja redondeado estilo MotoAmigo.
 * Uso: arrastrar desde palette o instanciar con new BotonNaranja("Texto")
 */
public class BotonNaranja extends JButton {

    private static final Color COLOR_NORMAL   = new Color(255, 107, 0);   
    private static final Color COLOR_HOVER    = new Color(230, 90, 0);    
    private static final Color COLOR_PRESSED  = new Color(200, 75, 0);    
