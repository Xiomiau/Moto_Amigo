...
/**
 * Botón rojo redondeado para acciones de rechazo.
 */
public class BotonRojo extends JButton {

    private static final Color COLOR_NORMAL  = new Color(220, 53, 69);   // #DC3545
    private static final Color COLOR_HOVER   = new Color(190, 40, 55);
    private static final Color COLOR_PRESSED = new Color(160, 30, 45);
